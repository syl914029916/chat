...
public class QqClientLogin extends JFrame implements ActionListener {
	...
	JTabbedPane jtp;
	JPanel jp2, jp3, jp4;
	JLabel jp2_jbl1, jp2_jbl2, jp2_jbl4;
...
//		jp2_jbl3.setForeground(Color.blue);
		...
		jp2_jbl3=new JButton(new ImageIcon("image/wjmm.jpg"));
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == jp1_jb1) {
			...
			JTable_Test3 jtt=new JTable_Test3();
			new StuAddDialog(jtt,"添加用户",true);
			//清除号码
		}else if(arg0.getSource() == jp2_jb1) {
			jp2_jtf.setText(null);
			//忘记密码
		}else if(arg0.getSource() == jp2_jbl3) {
			JTable_Test3 jtt3=new JTable_Test3();
		}
	}
