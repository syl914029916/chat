...
public class QqFriendList extends JFrame implements ActionListener, MouseListener {
	...
	public QqFriendList(String ownerId) {
		this.owner = ownerId;
		// 处理第一张卡片(显示好友列表)
		jphy_jb1 = new JButton("老铁");
//		jphy_jb2 = new JButton("宝贝");
//		jphy_jb2.addActionListener(this);
//		jphy_jb3 = new JButton("兄嘚");
...
//		jphy3.add(jphy_jb3);
		...
		// 处理第二张卡片
//
//		jpmsr_jb1 = new JButton("老铁");
//		jpmsr_jb1.addActionListener(this);
//		jpmsr_jb2 = new JButton("宝贝");
//		jpmsr_jb3 = new JButton("兄嘚");
...
//			System.out.print("你是"+friendName);
			//连接数据库
			sqlh2 = new SqlHelper();
...
//			System.out.println("你是"+pw2);
			String friendNo = pw2.trim();
			// System.out.println("你希望和 "+friendNo+" 聊天");
			//System.out.println("嘤嘤嘤"+owner+friendNo);
